...
<b>NOTE:</b>
1. Film Zone Bot should have admin privillage.
...
- Film Zone Bot Supports both url and alert inline buttons.

<b>NOTE:</b>
1. Telegram will not allows you to send buttons without any content, so content is mandatory.
2. Film Zone Bot supports buttons with any telegram media type.
